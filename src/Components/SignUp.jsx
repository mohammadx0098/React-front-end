...
class SignUp extends React.Component {
    ...
    signupRequest() {
        axios.post(`${process.env.REACT_APP_API_BASE_URL}/accounts/register/`, {
    ...
    sendRegType() {
        ...
        if (isBenefactor) {
            axios.post(`${process.env.REACT_APP_API_BASE_URL}/benefactors/`, '', {
                headers: {
        ...
        if (ischarity) {
            axios.post(`${process.env.REACT_APP_API_BASE_URL}/charities/`, {
